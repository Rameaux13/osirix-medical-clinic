      ...
      <div className="flex-1 flex items-center sm:items-start sm:pt-8 md:pt-10 lg:pt-12 justify-center px-4 py-6">
        <div className="max-w-md w-full">
          ...
          <div className="bg-theme-card rounded-xl sm:rounded-2xl shadow-theme-xl border border-theme p-5 sm:p-6 md:p-8 theme-transition">
            ...
            {message && (
              <div
                className={`mb-4 md:mb-6 p-3 md:p-4 rounded-lg md:rounded-xl theme-transition ${message.type === 'success'
              ...
              >
                <div className="flex items-start">
                  ...
                  <p className={`text-xs md:text-sm font-semibold ${message.type === 'success'
            ...
            <div className="space-y-5 md:space-y-6">
              ...
              <div className="text-center">
                <a
                  ...
                  className={`inline-flex items-center justify-center w-full py-3 sm:py-3.5 px-4 sm:px-6 rounded-lg sm:rounded-xl font-bold text-sm md:text-base transition-all shadow-lg ${isLoading || !email
