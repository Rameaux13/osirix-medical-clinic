    ...
    <div className="min-h-screen">
      ...
      >
        <div className="max-w-5xl mx-auto px-6 text-center animate-fade-in">
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black mb-8 leading-tight drop-shadow-lg tracking-wide">
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-primary-500 mb-8 leading-tight">
      ...
      {/* Section Services */}
      <section id="services" className="py-20 md:py-28 px-4 md:px-6 bg-gradient-to-br from-neutral-100 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 md:mb-24">
            <div className="inline-block px-8 py-3 bg-primary-100 text-primary-600 rounded-full text-base md:text-lg font-semibold uppercase tracking-wider mb-6">
              Nos Expertises
            </div>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-primary-500 mb-8 leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
            ...
            <div className="group bg-white rounded-3xl p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border border-neutral-200 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="inline-block px-4 py-2 bg-secondary-100 text-secondary-700 rounded-full text-base font-semibold mb-6">
                  Consultation
                </div>
                ...
                <button className="w-full py-4 px-8 bg-primary-500 hover:bg-primary-600 text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-lg text-lg md:text-xl">
                  En savoir plus
                </button>
              </div>
            </div>
            ...
            <div className="group bg-white rounded-3xl p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border border-neutral-200 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="inline-block px-4 py-2 bg-primary-100 text-primary-700 rounded-full text-base font-semibold mb-6">
                  Laboratoire
                </div>
                ...
                <button className="w-full py-4 px-8 bg-secondary-500 hover:bg-secondary-600 text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-lg text-lg md:text-xl">
                  En savoir plus
                </button>
              </div>
            </div>
      ...
      <section className="py-24 bg-neutral-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-6xl font-black text-primary-500 mb-6 tracking-wide">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {/* Docteur 1 */}
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 text-center">
              <div className="w-32 h-32 mx-auto mb-8 rounded-full overflow-hidden border-4 border-secondary-500 shadow-lg">
                <Image
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="bg-white rounded-2xl p-10 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 relative">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-primary-500 text-lg md:text-xl">Aminata Mbaye</h4>
                  <p className="text-base text-neutral-600">Patiente depuis 2 ans</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-10 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 relative">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-primary-500 text-lg md:text-xl">Kouassi Désirée</h4>
                  <p className="text-base text-neutral-600">Patiente depuis 1 an</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-10 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 relative">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-primary-500 text-lg md:text-xl">Jean Baptiste</h4>
                  <p className="text-base text-neutral-600">Patient depuis 3 ans</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="avis" className="py-20 md:py-28 bg-gradient-to-br from-primary-50 to-secondary-50 relative overflow-hidden">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-primary-100 relative overflow-hidden">
            ...
            <form onSubmit={handleFeedbackSubmit} className="space-y-8 md:space-y-10">
              <div className="text-center">
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-primary-600 mb-3">
                  Donnez votre Avis
                </h3>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label htmlFor="name" className="block text-lg md:text-xl font-semibold text-primary-700">
                    Nom complet *
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full px-5 py-4 border-2 border-neutral-300 rounded-xl focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition-all duration-200 text-neutral-800 placeholder-neutral-500 text-lg md:text-xl"
                    placeholder="Votre nom et prénom"
                  />
                </div>

                <div className="space-y-3">
                  <label htmlFor="email" className="block text-lg md:text-xl font-semibold text-primary-700">
                    Adresse email *
                  </label>
                  <input
                    type="email"
              ...
              <div className="space-y-5">
                <label className="block text-lg md:text-xl font-semibold text-primary-700">
                  Votre évaluation *
                </label>
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                  ...
                  <div className="text-lg md:text-xl font-medium text-neutral-700">
              ...
              <div className="space-y-3">
                <label htmlFor="message" className="block text-lg md:text-xl font-semibold text-primary-700">
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-5 py-4 border-2 border-neutral-300 rounded-xl focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition-all duration-200 text-neutral-800 placeholder-neutral-500 resize-none text-lg md:text-xl"
            ...
            <div className="mt-10 p-6 bg-primary-50 rounded-xl border border-primary-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg md:text-xl font-semibold text-primary-700 mb-2">
      ...
      {/* Footer */}
      <footer id="contact" className="bg-primary-600 text-neutral-100 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
            {/* Section 1 */}
            <div>
              <h3 className="text-secondary-500 font-bold text-2xl mb-6 uppercase tracking-wide">
            ...
            <div>
              <h3 className="text-secondary-500 font-bold text-2xl mb-8 uppercase tracking-wide">
                Suivez-nous
              </h3>
                ...
                <Link href="#" className="group" aria-label="WhatsApp">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 bg-secondary-500 rounded-full flex items-center justify-center hover:bg-secondary-600 transition-all duration-300 hover:scale-110 shadow-xl hover:shadow-2xl">
                    <Image
                      ...
                      width={100}
                      height={100}
                      className="w-24 h-24 sm:w-20 sm:h-17"
                    />
                  </div>
                </Link>
              </div>
          ...
          {/* Footer Bottom */}
          <div className="border-t border-primary-700 mt-16 pt-10 text-center text-lg md:text-xl">
